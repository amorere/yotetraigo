...
review1 = Review.create(rating: 5, comment: "Excelente conductor", user_id: user2.id, booking_id: booking1.id)

# 4. create a booking for that user
booking1 = Booking.create(status: "Confirmed", user_id: user2.id, application_id: application1.id , car_id: car1.id, review_id:)
